...
<div component="topic/quickreply/container" class="clearfix quick-reply">
	...
	<form method="post" action="{config.relative_path}/compose">
		...
		<div class="btn-group float-end">
			...
			<button type="submit" component="topic/quickreply/expand" class="btn btn-outline-primary" formmethod="get"><i class="fa fa-expand"></i> [[persona:pr-quickreply.expand]]</button>
		</div>
	</form>
